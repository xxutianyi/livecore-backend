...
Route::prefix('client')->middleware('client')->group(function () {
    ...
    Route::get('audiences/{audience}/viewing-records', [Client\ExternalController::class, 'viewingRecords']);
...
Route::middleware('guest')->group(function () {
    Route::post('token', [Api\Auth\AuthTokenController::class, 'store']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('token', [Api\Auth\AuthTokenController::class, 'destroy']);
    ...
    Route::prefix('systems')->can('viewAdmin')->group(function () {
    ...
    Route::prefix('settings')->can('viewRoomAdmin')->group(function () {
